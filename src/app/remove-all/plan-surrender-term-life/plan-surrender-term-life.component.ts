...
@Component({
  selector: 'ignatica-plan-surrender-term-life',
  templateUrl: './plan-surrender-term-life.component.html',
  styleUrls: ['./plan-surrender-term-life.component.scss'],
})
export class PlanSurrenderTermLifeComponent implements OnInit {
