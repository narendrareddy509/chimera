...
@Component({
  selector: 'ignatica-plan-surrender-rate-table',
  templateUrl: './plan-surrender-rate-table.component.html',
  styleUrls: ['./plan-surrender-rate-table.component.scss'],
})
export class PlanSurrenderRateTableComponent implements OnInit {
