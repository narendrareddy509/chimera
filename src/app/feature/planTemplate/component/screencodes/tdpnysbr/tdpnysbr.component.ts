...
@Component({
  selector: 'ignatica-tdpnysbr',
  templateUrl: './tdpnysbr.component.html',
  styleUrls: ['./tdpnysbr.component.scss'],
})
export class TdpnysbrComponent {
  ...
  constructor(
    ...
    this.route.params.subscribe(({ action, id }) => {
      ...
      if (action == 'new') {
        ...
        this.plan.benefitConfiguration.endowmentBenefitOptions =
          new EndowmentBenefitOptions();
        this.plan.benefitConfiguration.endowmentBenefitOptions.endowmentBenefitRateTable =
          [];
      ...
      if (action == 'edit' || action == 'clone') {
        this.planService.getPlan(this.planId).subscribe((response: any) => {
          ...
          if (plan) {
            ...
            if (!this.plan.benefitConfiguration.endowmentBenefitOptions) {
              this.plan.benefitConfiguration.endowmentBenefitOptions =
                new EndowmentBenefitOptions();
              this.plan.benefitConfiguration.endowmentBenefitOptions.endowmentBenefitRateTable =
                [];
