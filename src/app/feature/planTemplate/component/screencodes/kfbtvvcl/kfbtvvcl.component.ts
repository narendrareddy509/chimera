...
@Component({
  selector: 'ignatica-kfbtvvcl',
  templateUrl: './kfbtvvcl.component.html',
  styleUrls: ['./kfbtvvcl.component.scss'],
})
export class KfbtvvclComponent implements OnInit {
  ...
  @ViewChild(FundWithdrawalComponent)
  fundWithdrawalChild: FundWithdrawalComponent;
  @ViewChild(PlanDisbursementComponent)
  PlanDisbursementChild: PlanDisbursementComponent;
  @ViewChild(PlanCashValueComponent)
  PlanCashValueChild: PlanCashValueComponent;
  ...
  savePlan(action: string) {
    ...
    let planDeathBenefitValid = this.planDeathBenefitsChild.formValid;
    ...
    if (
      ...
      if (
        this.PlanDisbursementChild &&
        this.PlanDisbursementChild.selectedObject
      ) {
        this.plan.generalConfiguration.planModules.push(
          this.PlanDisbursementChild.selectedObject
        );
      ...
      if (
        this.PlanCashValueChild &&
        this.PlanCashValueChild.cashValueSelectedModuleObject
      ) {
        this.plan.generalConfiguration.planModules.push(
          this.PlanCashValueChild.cashValueSelectedModuleObject
        );
