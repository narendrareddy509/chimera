...
@Component({
  selector: 'ignatica-rsweahxf',
  templateUrl: './rsweahxf.component.html',
  styleUrls: ['./rsweahxf.component.scss'],
})
export class RsweahxfComponent implements OnInit {
  ...
  @ViewChild(PlanReinstatementFormulaComponent)
  PlanReinstatementFormulaComponent: PlanReinstatementFormulaComponent;
  ...
  constructor(
    ...
    this.route.params.subscribe(({ action, id }) => {
      ...
      if (action == 'new') {
        ...
        this.plan.benefitConfiguration.noClaimBenefitOptions =
          new NoClaimBenefitOptions();
        this.plan.benefitConfiguration.noClaimBenefitOptions.noClaimBenefitRateTable =
          [];
      ...
      if (action == 'edit' || action == 'clone') {
        this.planService.getPlan(this.planId).subscribe((response: any) => {
          ...
          if (plan) {
            ...
            if (!this.plan.benefitConfiguration.noClaimBenefitOptions) {
              this.plan.benefitConfiguration.noClaimBenefitOptions =
                new NoClaimBenefitOptions();
              this.plan.benefitConfiguration.noClaimBenefitOptions.noClaimBenefitRateTable =
                [];
  ...
  savePlan(action: string) {
    ...
    if (
      ...
      if (
        this.PlanReinstatementFormulaComponent &&
        this.PlanReinstatementFormulaComponent.selectedReinstatementFormulaObj
      ) {
        this.plan.generalConfiguration.planModules.push(
          this.PlanReinstatementFormulaComponent.selectedReinstatementFormulaObj
        );
