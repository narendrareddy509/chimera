...
@Component({
  selector: 'ignatica-ugbtofih',
  templateUrl: './ugbtofih.component.html',
  styleUrls: ['./ugbtofih.component.scss'],
})
export class UgbtofihComponent implements OnInit {
  ...
  @ViewChild(PlanCoiTakafulIlasComponent)
  planCoiComponent: PlanCoiTakafulIlasComponent;
  ...
  @ViewChild(PlanInvestmtOptionsComponent)
  investmentOptionsComponent: PlanInvestmtOptionsComponent;
  ...
  savePlan(action: string) {
    ...
    let underwritingValid = this.planUnderwritingChild
      ...
      : true;
    let planDeathBenefitsValid = this.planDeathBenefitsChild
      ? this.planDeathBenefitsChild.formValid
      : true;
